...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="bg-customer px-4 pt-12 pb-6">
        <div className="flex items-center gap-3">
          <Logo size={36} />
          <div>
            <h1 className="text-white font-bold text-xl leading-tight">Grab &amp; Go</h1>
            <p className="text-customer-light text-xs opacity-80">Campus Cafeteria</p>
          </div>
        </div>

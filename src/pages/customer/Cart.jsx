  ...
  if (items.length === 0) {
    return (
      <div className="flex flex-col h-full items-center justify-center px-6 pb-24">
        ...
        <p className="text-sm text-gray-500 mt-1 text-center">Browse restaurants and add items to get started</p>
        <button
          onClick={() => navigate('/customer')}
          className="mt-6 bg-customer text-white rounded-xl px-6 py-3 font-semibold text-sm"
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-44">
        ...
        <button
          onClick={clearCart}
          className="mt-3 text-xs text-red-400 text-center w-full py-2"
        >Clear cart</button>
      </div>
      ...
      <div className="fixed bottom-16 left-0 right-0 px-4 pb-2 bg-white border-t border-gray-100 pt-3">
        <button
          ...
          className="w-full bg-customer text-white rounded-xl py-3.5 font-bold text-sm"
